...
func WitchesDatabase(DB_DRIVER string) {
	...
	content := utils.CreateContentRefreshUsed(APP_PORT, APP_HOST, DB_DRIVER, DB_USER, DB_HOST, DB_PORT, DB_NAME, DB_PASSWORD, DB_URL, REDIS_HOST, REDIS_PORT, REDIS_PASSWORD, ACCESS_TOKEN_TTL, REFRESH_TOKEN_TTL, SESSION_TTL, IDLE_TIMEOUT, REVOKED_TTL, RATE_LIMIT_PERIOD, RATE_LIMIT_MAX)
