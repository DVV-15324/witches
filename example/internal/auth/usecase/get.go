...
func (a *AuthUseCase) GetAuthByEmail(ctx context.Context, email string) (*domainAuth.Auth, *w_resp.AppError) {
...
func (a *AuthUseCase) GetAuthByUserId(ctx context.Context, userId int) (*domainAuth.Auth, *w_resp.AppError) {
